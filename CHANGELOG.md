...
- **Optional skill generation** via `node gitnexus/dist/cli/index.js analyze --skills` — generates AI agent skills from KuzuDB knowledge graph (#171) — @zander-raycraft
